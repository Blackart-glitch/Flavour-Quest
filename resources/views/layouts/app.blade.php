                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('home') }}">
                            <span class="material-icons icon-lg align-middle">house</span>
                            Home
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('getrecipe') }}">
                            <span class="material-icons icon-lg align-middle">search</span>
                            Recipes
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#Ingredients">
                            <span class="material-icons icon-lg align-middle">blender</span>
                            Ingredients
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('cookingtips') }}">
                            <span class="material-icons icon-lg align-middle">tips_and_updates</span>
                            Cooking
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">
                            <span class="material-icons icon-lg align-middle">contact_support</span>
                            Contact
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">
                            <span class="material-icons icon-lg align-middle">logout</span>
                            Logout
                        </a>
                    </li>
                </ul>
